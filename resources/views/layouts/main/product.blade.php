...
<html lang="en">
	<head>
		...
		<!-- Libs CSS
			============================================ -->
		<link rel="stylesheet" href="{{ url('main/css/bootstrap/css/bootstrap.min.css') }}">
		<link href="{{ url('main/css/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet">
		<link href="{{ url('main/js/datetimepicker/bootstrap-datetimepicker.min.css') }}" rel="stylesheet">
		...
		<link href="{{ url('main/css/themecss/so-categories.css') }}" rel="stylesheet">
		<link href="{{ url('main/css/themecss/so-listing-tabs.css') }}" rel="stylesheet">
		<link href="{{ url('main/css/footer.css') }}" rel="stylesheet">
								...
								<div class="module clearfissx">
									...
									<div class="modcontent">
										<ul class="menu">
                                            ...
                                            <li><a href="{{ route('locate-a-store') }}">Locate A Store</a></li>
										</ul>
									</div>
								</div>
                            </div>
