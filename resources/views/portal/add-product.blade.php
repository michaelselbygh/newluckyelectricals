                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="name" name="name"  class="form-control round {{ $errors->has('name') ? 'form-control is-invalid' : '' }}" placeholder="Enter product name" value="{{ old('name') }}" type="text" required>
                                    @if ($errors->has('name'))
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description" class="form-control round {{ $errors->has('description') ? 'form-control is-invalid' : '' }}" placeholder="Enter Product Description">{{ old('description') }}</textarea>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="features" name="features" class="form-control round {{ $errors->has('features') ? 'form-control is-invalid' : '' }}" placeholder="Enter Product Highlighted Features" required>{{ old('features') }}</textarea>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control {{ $errors->has('category') ? 'form-control is-invalid' : '' }}" name='category' style='border-radius:7px;' required>
                                        ...
                                        @for ($i = 0; $i < sizeof($categories) ; $i++)
                                            <option value="{{ $categories[$i]['id'] }}" {{ old('category')== $categories[$i]['id'] ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="tags" tags="tags"  class="form-control round {{ $errors->has('tags') ? 'form-control is-invalid' : '' }}" placeholder="Enter product tags" value="{{ old('tags') }}" type="text">
                                    @if ($errors->has('tags'))
                                        <div class="invalid-feedback">
